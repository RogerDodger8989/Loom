...
async function syncRoutes(fastify) {
    ...
    fastify.post('/api/sync/trigger', {
        ...
        if (rating_sync_1.syncStatus.isSyncing) {
        ...
        (0, rating_sync_1.syncAllExternalData)().catch((err) => {
    ...
    fastify.get('/api/sync/status', {
        ...
        return reply.send(rating_sync_1.syncStatus);
    });
}
